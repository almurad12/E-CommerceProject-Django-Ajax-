...
from mainshop.views import home,shopSingleproduct,ShopList,SearchProduct,watchlist_add_cookie,show_cookies,remove_from_wishlist,add_to_cart,show_cart,checkout,remove_from_cart,admindashbaord,CategoryViewSet,SubCategoryViewSet,SliderItemViewSet,adminproduct,ProductViewSet,ProductImageViewSet,create_product,ProductListAPIView,ProductDetailAPIView,loginAdminSite,admin_logout,get_all_session,orderItem
